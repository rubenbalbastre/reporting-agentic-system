...
export default function TeachAgentModal({
  ...
  return (
    <div className="modal-backdrop" onClick={onClose} role="presentation">
      <section
        className={`teach-modal ${expanded ? "expanded" : ""}`}
      ...
      >
        <div className="panel-head">
          ...
          <div className="teach-header-actions">
            <button onClick={onToggleExpanded}>{expanded ? "Restore" : "Maximize"}</button>
          ...
          {activeSkillId && (
            <div className="skill-chat-section">
              ...
              <div className="teach-actions">
                ...
                <button className="btn-legacy" onClick={onLegacyQuickSave} disabled={teachLoading}>
                  Legacy Quick Save
                </button>
              </div>
            </div>
